...
#. Set up targets for provisioning with non-default "Offloading Modes"
   ...
   PXE booted (bootstrapped), the most common annoyance being wrong defaults
...
#. Set up targets for "Verify Networks" with non-default "Offloading Modes"
   ...
   **NOTE**: Check *Reference 15* for an updated and comprehensive list of
   ...
   need this change, you have two options:

   - Skip running automatic "Verify Networks";

   - Apply "Offloading Modes" settings by hand to bootstrapped nodes;
