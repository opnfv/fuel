...
There are a number of possibilies regarding the virtual machines which can be spawned on the compute nodes.
The current host kernel (4.15.0-13-generic) supports the following UEFI-images and kernels for the guests:
