...
has to be made to irtio-scsi and attach all drives in /dev/sdX. Virtio-scsi is a little worse in terms of
...
.More details regarding the differences and performance of virtio-blk bs virtio-scsi are beyond the scope
