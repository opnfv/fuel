...
#. Virtual deploy
   ...
   available at http://<proxy public VIP>.
...
#. Baremetal deploy
   ...
   available at http://<proxy public VIP>:8090, e.g. http://172.30.10.103:8090.
...
- nova_cpu_pinning: List of CPU cores nova will be pinned to. Currently disabled in MCP.
