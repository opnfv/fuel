...
7) `Saltstack Documentation <https://docs.saltstack.com/en/latest/topics>`_
8) `Saltstack Formulas <http://salt-formulas.readthedocs.io/en/latest/develop/overview-reclass.html>`_

Reclass

9) `Reclass model <http://reclass.pantsfullofunix.net>`_
