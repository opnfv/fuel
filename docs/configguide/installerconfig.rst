...
Fuel, see *Reference 13* in section *"Fuel assosiated references"* below.
...
- Fuel planning guide, please see *Reference: 8* in section *"Fuel assosiated references"* below.

- Fuel user guide, please see *Reference: 9* in section *"Fuel assosiated references"* below.

- Fuel operations guide, please see *Reference: 10* in section *"Fuel assosiated references"* below.

- Fuel Plugin Developers Guide, please see *Reference: 11* in section *"Fuel assosiated references"* below.
...
a Fuel OPNFV .iso can be found in *Reference: 14* at section *"Fuel assosiated references"* below.
...
For information on compatible hardware types available for use, please see *Reference: 11* in section *"Fuel assosiated references"* below.
...
server, reboot it, and install the Fuel Jumphost in accordance with installation instructions, see *Reference 13* in section *"Fuel assosiated references"*
below.
...
*"Fuel assosiated references"* below.
...
instructions, see *Reference 13* in section *"Fuel assosiated references"* below..
...
*Reference 13*, provided in section *"Fuel assosiated references"* below..
...
For detailed guide-lines on node allocation, please refer to the installation instructions found in *Reference 13*, provided in section *"Fuel assosiated references"* below..
...
in section *"Fuel assosiated references"* below.
