...
#  echo 'SUBSYSTEM=="net", ACTION=="add", KERNEL=="vnet*", RUN+="/sbin/ip link set '"'"%k"'"' mtu 9000"' |& sudo tee "${_conf}"
  echo 'SUBSYSTEM=="net", ACTION=="add", KERNEL=="vnet*", ATTR{mtu}="9000"' |& sudo tee "${_conf}"
