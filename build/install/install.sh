...
copy_packages() {
    ...
    # NOTE! TODO! Need to temporarily use mos-master, should be mos10.0 when
    # fully populated!
    apt-ftparchive -c "${APT_REL_CONF}" release dists/mos-master/ > dists/mos-master/Release
    gzip -9cf dists/mos-master/Release > dists/mos-master/Release.gz
